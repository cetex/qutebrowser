...
class TestPageLifecycle:
    ...
    def test_stub_fallback_on_old_webengine(
        ...
        """On QtWebEngine < 6.11, the discard timer still schedules, but
        firing it falls back to a stub instead of a real discard (#8826).
        """
...
class TestDoDiscard:
    ...
    def test_real_discard_when_supported(self, seeded_tab, set_state_mock):
        """When the engine supports it, discard the page directly and leave
